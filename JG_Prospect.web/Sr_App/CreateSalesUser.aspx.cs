    ...
    public partial class CreateSalesUser : System.Web.UI.Page
    {
                ...
                if (Request.QueryString["ID"] != null)
                {
                    ...
                    if (ds.Tables[0].Rows.Count != 0)
                    {
                        ...
                        if (Convert.ToString(ds.Tables[0].Rows[0][6]) != "")
                        {
                            ...
                            if (ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.InstallProspect).ToString())
                            {
                                rqDesignition.Enabled = false;
                                RequiredFieldValidator3.Enabled = false;
                                lblReqDesig.Visible = false;
                            ...
                            else if (ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.Applicant).ToString())
                            {
                                rqDesignition.Enabled = false;
                                RequiredFieldValidator3.Enabled = false;
                                lblReqDesig.Visible = false;
                            ...
                            else if (ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.OfferMade).ToString())
                            {
                                rqDesignition.Enabled = true;
                            ...
                            else if (ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.Active).ToString())
                            {
                                rqDesignition.Enabled = true;
                                RequiredFieldValidator3.Enabled = true;
                                lblReqDesig.Visible = true;
                                ...
                                if ((ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.Active).ToString())
                                    || (ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.OfferMade).ToString()))
                                {
                        ...
                        if (ds.Tables[0].Rows[0][6].ToString() == Convert.ToInt16(JGConstant.InstallUserStatus.Active).ToString()
                            || ds.Tables[0].Rows[0][6].ToString() == Convert.ToInt16(JGConstant.InstallUserStatus.OfferMade).ToString())
                        {
                        ...
                        if (ds.Tables[0].Rows[0][6].ToString() == Convert.ToInt16(JGConstant.InstallUserStatus.Deactive).ToString())
                        {
                        ...
                        if (ds.Tables[0].Rows[0][40].ToString() != "" && ds.Tables[0].Rows[0][6].ToString() != Convert.ToInt16(JGConstant.InstallUserStatus.InterviewDate).ToString() )
                        {
                            txtReson.Text = ds.Tables[0].Rows[0][40].ToString();
                            txtReson.Visible = true;
                            ddlInsteviewtime.Visible = false;
                        }
                        else if (ds.Tables[0].Rows[0][40].ToString() != "" && ds.Tables[0].Rows[0][6].ToString() == Convert.ToInt16(JGConstant.InstallUserStatus.InterviewDate).ToString())
                        {
                        ...
                        txtSalaryRequirments.Text = Convert.ToString(ds.Tables[0].Rows[0]["SalaryReq"]);
        ...
        protected void Yes_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtReson.Visible == true && ddlstatus.SelectedValue != Convert.ToInt16(JGConstant.InstallUserStatus.InterviewDate).ToString())
                {
                    objuser.Reason = txtReson.Text;
                }
                else if (dtInterviewDate.Visible == true && ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.InterviewDate).ToString())
                {
        ...
        protected void CreateUser(object sender, EventArgs e)
        {
            ...
            //if (chkboxcondition.Checked == true)
            {
                ...
                objuser.Source = ddlSource.SelectedValue;
                objuser.Notes = txtNotes.Text;
                if (txtReson.Visible == true && ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.Rejected).ToString())
                {
                ...
                else
                {
                    try
                    {
                        ...
                        //lblmsg.CssClass = "success";
                        //lblmsg.Text = "User has been created successfully";
                        //if (ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.InterviewDate).ToString() || ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.OfferMade).ToString() || ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.Deactive).ToString())
                        if (ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.Deactive).ToString())
                        {
                        ...
                        if (ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.OfferMade).ToString())
                        {
        ...
        /// <summary>
        /// Add Update User Phone and email vlaue 
        /// </summary>
        /// <param name="IsInsert"></param>
        private void AddUpdateUserPhoneEmail(bool IsInsert, int UserID)
        {
            ...
            {
                string strHidPhoneValue = hidExtPhone.Value;
                string delimeter = "|,|";
                string Subdelimeter = "|%|";
                //PhoneValue = '0' + Subdelimeter + 'Phone1' + Subdelimeter + 'skype' + delimeter + '1' + Subdelimeter + 'Phone2' + Subdelimeter + 'whatsapp';
                if (strHidPhoneValue.IndexOf(delimeter) < 0)
                    strHidPhoneValue = strHidPhoneValue + delimeter;
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Convert.ToString(Session["PrevDesig"]) != ddldesignation.SelectedValue || ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.Deactive).ToString())
                {
        ...
        protected void ddlstatus_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Convert.ToString(Session["PreviousStatusNew"]) == Convert.ToInt16(JGConstant.InstallUserStatus.Active).ToString() && (!(Convert.ToString(Session["usertype"]).Contains("Admin"))))
            {
            ...
            if ((Convert.ToString(Session["PreviousStatusNew"]) == Convert.ToInt16(JGConstant.InstallUserStatus.Active).ToString()) && (!(Convert.ToString(Session["usertype"]).Contains("Admin")) && !(Convert.ToString(Session["usertype"]).Contains("SM"))))
            {
                //binddata();
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('You dont have rights change the status.')", true);
                return;
            }
            else if ((Convert.ToString(Session["PreviousStatusNew"]) == Convert.ToInt16(JGConstant.InstallUserStatus.Active).ToString() && ddlstatus.SelectedValue != Convert.ToInt16(JGConstant.InstallUserStatus.Deactive).ToString()) && ((Convert.ToString(Session["usertype"]).Contains("Admin")) || (Convert.ToString(Session["usertype"]).Contains("SM"))))
            {
            ...
            if (ddlstatus.SelectedValue ==Convert.ToInt16(JGConstant.InstallUserStatus.InstallProspect).ToString())
            {
                ...
                {
                    ddlstatus.SelectedValue = Convert.ToInt16(JGConstant.InstallUserStatus.Applicant).ToString();
                }
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Status cannot be changed to Install Prospect')", true);
                return;
            }
            else if (ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.Deactive).ToString())
            {
                if (Convert.ToString(Session["PreviousStatusNew"]) != Convert.ToInt16(JGConstant.InstallUserStatus.Active).ToString() && Convert.ToString(Session["PreviousStatusNew"]) != "")
                {
                    ddlstatus.SelectedValue = Convert.ToString(Session["PreviousStatusNew"]);
            ...
            else if (ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.Rejected).ToString() )
            {
                ddlInsteviewtime.Visible = false;
                dtInterviewDate.Visible = false;
            ...
            else if (ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.InterviewDate).ToString())
            {
            ...
            if (ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.Deactive).ToString() && (!(Convert.ToString(Session["usertype"]).Contains("Admin")) && !(Convert.ToString(Session["usertype"]).Contains("SM"))))
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('You dont have permission to Activate or Deactivate user')", true);
                if (Convert.ToString(Session["ddlStatus"]) != "")
                {
            ...
            if ((ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.OfferMade).ToString()) && (ddldesignation.SelectedItem.Text == "ForeMan" || ddldesignation.SelectedItem.Text == "Installer"))
            {
                showHideNewHireSection(true);
                txtReson.Visible = false;
            ...
            if (ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.Applicant).ToString())
            {
                rqDesignition.Enabled = false;
                RequiredFieldValidator3.Enabled = false;
                lblReqDesig.Visible = false;
        ...
        protected void ddlstatus_PreRender(object sender, EventArgs e)
        {
            ...
            //    {
            //        case Convert.ToInt16(JGConstant.InstallUserStatus.Applicant).ToString():
            ...
            //            ddlstatus.Items[i].Attributes["data-image"] = imageURL;
            //            break;
            //        case Convert.ToInt16(JGConstant.InstallUserStatus.InterviewDate).ToString():
        ...
        private void clearcontrols()
        {
            ...
            //rdoGuiltyYes.Enabled = true;
            //txtStartDateNew.Enabled = true;
            txtSalaryRequirments.Enabled = true;
            //txtAvailability.Enabled = true;
            //txtWarrantyPolicy.Enabled = true;
            //txtYrs.Enabled = true;
            //txtCurrentComp.Enabled = true;
        ...
        private string GetUpdatedId(string PrevId)
        {
            ...
            var selDesignation = (JGConstant.DesignationType)Convert.ToInt32(ddldesignation.SelectedValue);
            if ((selDesignation == JGConstant.DesignationType.Admin || selDesignation == JGConstant.DesignationType.Office_Manager || selDesignation == JGConstant.DesignationType.Recruiter) && (ddlstatus.SelectedValue != Convert.ToInt16(JGConstant.InstallUserStatus.Deactive).ToString()))
            {
                if (SalesId != "")
                {
            ...
            else if ((selDesignation == JGConstant.DesignationType.Admin || selDesignation == JGConstant.DesignationType.Office_Manager || selDesignation == JGConstant.DesignationType.Recruiter) && (ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.Deactive).ToString()) && (SalesId != ""))
            {
                SalesId = SalesId + "-X";
            }
            else if ((selDesignation == JGConstant.DesignationType.Jr_Sales || selDesignation == JGConstant.DesignationType.Jr_Project_Manager || selDesignation == JGConstant.DesignationType.Sales_Manager || selDesignation == JGConstant.DesignationType.Sr_Sales) && (ddlstatus.SelectedValue != Convert.ToInt16(JGConstant.InstallUserStatus.Deactive).ToString()))
            {
                if (SalesId != "")
                {
                    if (SalesId.Contains("SLE"))
            ...
            else if ((selDesignation == JGConstant.DesignationType.Jr_Sales || selDesignation == JGConstant.DesignationType.Jr_Project_Manager || selDesignation == JGConstant.DesignationType.Sales_Manager || selDesignation == JGConstant.DesignationType.Sr_Sales) && (ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.Deactive).ToString()) && (SalesId != ""))
            {
                SalesId = SalesId + "-X";
            }
        ...
        private void SendEmail(string emailId, string FName, string LName, string status, string Reason)
        {
            try
            {
                ...
                //Body.Append("<br>");
                ////if (status == "Source" || status == Convert.ToInt16(JGConstant.InstallUserStatus.Rejected).ToString() || status == "Interview Date" || status == "Offer Made")
                ////{
                //Body.Append(Reason);
                ////}
                //Body.Append("<br>");
        ...
        public void SendEmail(string emailId, string FName, string LName, string status, string Reason, string Designition, string HireDate, string EmpType, string PayRates, int htmlTempID, List<Attachment> Attachments = null)
        {
            try
            {
                ...
                if (status ==Convert.ToInt16(JGConstant.InstallUserStatus.OfferMade).ToString())
                {
                    // TODO : commented code for missing directive using Word = Microsoft.Office.Interop.Word;
                    //obj.createForeMenForJobAcceptance(strBody, FName, LName, Designition, emailId, HireDate, EmpType, PayRates);
                }
                if (status == Convert.ToInt16(JGConstant.InstallUserStatus.Deactive).ToString())
                {
                    // TODO : commented code for missing directive using Word = Microsoft.Office.Interop.Word;
        ...
        private void FillEmailIDhin(int id)
        {
            DataSet DsUserEmail = null;
        ...
        private void CreateUserEmailID()
        {
            ...
            if (Convert.ToString(Session["PreviousStatusNew"]) != Convert.ToInt16(JGConstant.InstallUserStatus.Active).ToString() && ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.Active).ToString())
            {
        ...
        private string GetId(string Desig)
        {
            ...
            if ((Desig == "Admin" || Desig == "Office Manager" || Desig == "Recruiter") && (ddlstatus.SelectedValue != Convert.ToInt16(JGConstant.InstallUserStatus.Deactive).ToString()))
            {
                if (SalesId != "")
                {
            ...
            else if ((Desig == "Admin" || Desig == "Office Manager" || Desig == "Recruiter") && (ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.Deactive).ToString()) && (SalesId != ""))
            {
                SalesId = SalesId + "-X";
            }
            else if ((Desig == "Jr. Sales" || Desig == "Jr Project Manager" || Desig == "Sales Manager" || Desig == "Sr. Sales") && (ddlstatus.SelectedValue != Convert.ToInt16(JGConstant.InstallUserStatus.Deactive).ToString()))
            {
                if (SalesId != "")
                {
                    LastInt = SalesId.Substring(SalesId.Length - 4);
            ...
            else if ((Desig == "Jr. Sales" || Desig == "Jr Project Manager" || Desig == "Sales Manager" || Desig == "Sr. Sales") && (ddlstatus.SelectedValue == Convert.ToInt16(JGConstant.InstallUserStatus.Deactive).ToString()) && (SalesId != ""))
            {
                SalesId = SalesId + "-X";
            }
